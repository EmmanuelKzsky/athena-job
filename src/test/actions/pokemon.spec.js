...
const pokemonListOkExpectedActions = [
  { type: `GET_${modelConst}_LIST_LOADING`, isLoading: true },
  { type: `GET_${modelConst}_LIST_LOADING`, isLoading: false },
];

const pokemonListErrorExpectedActions = [
  { type: `GET_${modelConst}_LIST_LOADING`, isLoading: true },
  { type: `GET_${modelConst}_LIST_ERROR`, response: {} },
  { type: `GET_${modelConst}_LIST_LOADING`, isLoading: false },
  { type: '@@redux-form/RESET' },
];
const pokemonOkExpectedActions = [
  { type: `GET_${modelConst}_LOADING`, isLoading: true },
  { type: `GET_${modelConst}_LOADING`, isLoading: false },
];

const pokemonErrorExpectedActions = [
  { type: `GET_${modelConst}_LOADING`, isLoading: true },
...
describe('actions', () => {
  ...
  it('should get an actions of pokemon list', () => {
    const request = fetchMock.post('https://pokeapi.co/api/v2/pokemon/?limit=20&offset=0', {
    ...
    return store.dispatch(actions.getPokemonsList('?limit=20&offset=0')).then(() => {
      expect(store.getActions()).
        toEqual(expect.arrayContaining(pokemonListOkExpectedActions));
    });
  });
